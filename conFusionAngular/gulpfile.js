...
// Clean json-server public folder
//gulp.task('clean-server', function () {
//    return del(['../json-server/public']);
//});
// Copy dist folder contents to the json-server public folder
//gulp.task('copy', ['clean', 'clean-server'], function () {
...
gulp.task('usemin', function () {
    return gulp.src('./app/**/*.html').pipe(usemin({
        css: [minifycss(), rev()],
